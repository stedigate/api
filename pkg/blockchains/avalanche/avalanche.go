...
func (e *Avalanche) GetUsdtContractEvents(lastScannedTrxID string) ([]TokenTransfer, error) {
	return e.getContractEventsByAddress(e.config.USDTAddress, lastScannedTrxID)
}

func (e *Avalanche) GetUsdcContractEvents(lastScannedTrxID string) ([]TokenTransfer, error) {
	return e.getContractEventsByAddress(e.config.USDCAddress, lastScannedTrxID)
}

func (e *Avalanche) getContractEventsByAddress(contract, lastScannedTrxID string) ([]TokenTransfer, error) {
...
func (e *Avalanche) GetBalance(address, currency string) (*big.Float, error) {
	switch currency {
	case "ETH":
...
func (e *Avalanche) getEthBalance(address string) (*big.Float, error) {
...
func (e *Avalanche) GetContractBalance(address, contract string) (*big.Float, error) {
...
func (e *Avalanche) fetchTokenTransfers(contract string, page int) ([]TokenTransfer, error) {
...
func (e *Avalanche) GetTransactionInfo(txId string) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) GetTrxBalance(address string) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) GetTransactions(address string) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) GetContractTransactions(address string) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) SendTrx(src Wallet, dest string, amount float64) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) SendUsdt(src Wallet, dest string, amount float64) ([]map[string]interface{}, error) {

	return nil, nil
}

func (e *Avalanche) createTransactionObject(log types.Log) (Transaction, error) {
