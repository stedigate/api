...
var BalanceCmd = &cobra.Command{
	Use:   "balance",
	Short: "Get the TRX/USDT/USDC balance of a wallet address",
	Long:  `Get the TRX/USDT/USDC balance of a wallet address.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		balance, err := t.GetBalance(publicKey, currency)
		if err != nil {
			panic(err)
		}
